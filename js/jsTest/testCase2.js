/******************************************************************************
 * File Name: testCase2.js
 * Author: Tony King (a.k.a. Copy/Paste)
...
function nextStep() {
    ...
    if (db.clickCount === 1) {
        ...
        m.set("Initialize a phone call and click 'Continue'", {
            wan1 : {
                packetLoss : 0,
                latency : 30,
                jitter : 0,
        ...
        var loopInterval = setInterval(function() {
            // set initial increment to 6PL 30Latency 20Jitter
            if (db.loopCount === 0) {
                m.set("Demo currently running...", {
                wan1 : {
                    packetLoss : m.tc1.getPacketLoss() + 6,
                    latency : m.tc1.getLatency() + 0,
            ...
            } else if (db.loopCount >= 1 && db.loopCount < 10) {
                m.set("Demo currently running...", {
                wan1 : {
                    packetLoss : m.tc1.getPacketLoss() + 4,
                    latency : m.tc1.getLatency() + 15,
                    jitter : m.tc1.getJitter() + 10,
                    download : 50,
                    upload : 10
                },
            });
